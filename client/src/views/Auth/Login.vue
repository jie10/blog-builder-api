      ...
      <div class="mx-auto w-full max-w-sm lg:w-96">
        <div>
          ...
          <!--          <p class="mt-2 text-sm text-gray-600">
                      Or
                      {{ ' ' }}
                      <a class="font-medium text-indigo-600 hover:text-indigo-500" href="#">start your 14-day free trial</a>
                    </p>-->
        </div>
          ...
          <div>
            <div>
              ...
              <div class="mt-1 grid grid-cols-3 gap-3">
                <div>
                  <a class="inline-flex w-full justify-center rounded-md border border-gray-300 bg-white py-2 px-4 text-sm font-medium text-gray-500 shadow-sm hover:bg-gray-50"
                     href="#">
            ...
            <form action="#" class="space-y-6" method="POST">
              ...
              <div class="flex items-center justify-between">
                <div class="flex items-center">
                  <input id="remember-me" class="h-4 w-4 rounded border-gray-300 text-indigo-600 focus:ring-indigo-500"
                         name="remember-me"
                         type="checkbox"/>
